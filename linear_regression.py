...
class LinearRegression:
    ...
    def gradient_descent(self, alpha, lambda_param, num_iterations):
        ...
        for _ in range(num_iterations):
            ...
            self.gradient_descent(alpha, lambda_param)
            # Save the cost J in every iteration.
            cost_history.append(self.cost_function(self.data, self.labels, self.lambda_param))
    ...
    def gradient_step(self, alpha, lambda_param):
        ...
        #Calculate regularization parmeter
